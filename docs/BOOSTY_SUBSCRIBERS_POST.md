...
Основной репозиторий продукта: `andrey271192/amnezia_web-PRO_test`.

Старый `andrey271192/amnezia-web-pro-deploy` оставлен только для совместимости со старыми инструкциями. Для новых установок используйте команды ниже напрямую из private repo.
